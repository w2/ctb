...
<?php for ($i = 0, $n = count($options); $i < $n; $i ++) { ?>
	...
	<div id="poll_loading_<?php echo $poll->id;?>" style="display:none;"><?php echo JText::_('MOD_MIJOPOLLS_PROCESSING'); ?>
	</div>		
...
<div id="poll_links" style="padding-top:5px; ">
	...
	<a class="poll_result_link" href="<?php echo JRoute::_('index.php?option=com_mijopolls&view=poll&id='.$slug.$itemid); ?>"><?php echo JText::_('MOD_MIJOPOLLS_VIEW_DETAILS'); ?></a><br />
	<?php endif; ?>
	...
	<a class="poll_result_link" target="<?php echo $params->get('rel_article_window'); ?>" href="<?php echo JRoute::_($params->get('rel_article')); ?>">
		<?php echo JText::_('MOD_MIJOPOLLS_READ_RELATED_ARTICLE'); ?> >></a>
	<?php endif; ?>
<?php } ?>
