 ...
 * <jdoc:incslude type="module" name="test" style="slider" />
 *
...
$template_name = explode( DIRECTORY_SEPARATOR, str_replace( array( '\html', '/html' ), '', dirname(__FILE__) ) );
$template_name = $template_name[ count( $template_name ) - 1 ];
require_once (JPATH_THEMES.DIRECTORY_SEPARATOR.$template_name.DIRECTORY_SEPARATOR.'php'.DIRECTORY_SEPARATOR.'lib'.DIRECTORY_SEPARATOR.'jsn_utils.php');

function modChrome_jsntrio($module, &$params, &$attribs) { 
	$jsnutils = &JSNUtils::getInstance();
?>
	<div class="module<?php echo $params->get('moduleclass_sfx'); ?> jsn-modulecontainer">
		...
		<div class="jsn-middle">
			<div class="jsn-middle_inner">
				...
				<?php endif; ?>
				<div class="jsn-modulecontent clearafter"><?php echo $module->content; ?></div>
			</div>
		</div>
