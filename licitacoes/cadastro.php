...
if( ((strcmp ($noraz, "") != 0) && (strcmp ($email, "") != 0) && (strcmp ($ddd, "") != 0) && (strcmp ($noraz, "") != 0) && (strcmp ($telefone, "") != 0) && (strcmp ($endereco, "") != 0) && (strcmp ($cidade, "") != 0) && (strcmp ($estado, "") != 0) && (strcmp ($natureza, "") != 0) && (strcmp ($cpfcnpj, "") != 0) && (strcmp ($licitacao, "") != 0)) && strlen($cpfcnpj) >= 11 && strlen($noraz) >= 5 && strlen($telefone) >= 7 && strlen($ddd) == 2 && strlen($email ) >= 5)
{
...
else 
{
  ...
  <body>
  <div class= 'jumbotron'>
  <h1 style='color:#FFFFFF'>Licitacões CTB</h1>
  <p style='color:#FFFFFF'> Erro na validação do formulario</p>
  </div>
     
    Voce deverá preencher todas as informacões para obter as licitacões. Se esta mensagem está aparecendo, então você esqueceu de preencher algum campo
...
if(mysql_query($query,$conexao))
{
  ...
  <div class= 'jumbotron'>
  <h1 style='color:#FFFFFF'>Licitacões CTB</h1>
  <p style='color:#FFFFFF'>Obrigado por ter respondido ao nosso formulário. As suas informacões foram gravadas em nosso banco de dados </p>
	</div>
     
     Para acessar o edital da licitacão, clique <a href='http://www.ctb.ba.gov.br/Licitacoes/edital01/editalPQVLT.pdf' target='new' >aqui</a> para abrir novamente<br/>
...
*/
  ...
  <p style='color:#FFFFFF'>Obrigado por ter respondido ao nosso formulário. As suas informacões foram gravadas em nosso banco de dados </p>
	...
	else if(strcmp($licitacao, "Edital TP 04-2014") == 0){
  ...
  <div class= 'jumbotron'>
  <h1 style='color:#FFFFFF'>Licitacões CTB</h1>
  <p style='color:#FFFFFF'>Obrigado por ter respondido ao nosso formulário. As suas informacoes foram gravadas em nosso banco de dados. </p>
  </div>
     
     Para acessar o edital da licitação, clique <a href='http://www.ctb.ba.gov.br/Licitacoes/edital03/esclarecimentosTP04-14.pdf' target='new' >aqui</a><br/>
