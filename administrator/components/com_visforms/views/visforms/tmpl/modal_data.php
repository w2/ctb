...
?>
<form action="<?php echo JRoute::_('index.php?option=com_visforms&view=visforms&layout=modal_data&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm" class="form-inline">
