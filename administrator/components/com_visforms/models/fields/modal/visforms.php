...
class JFormFieldModal_Visforms extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '	<a class="modal" title="'.JText::_('COM_VISFORMS_CHANGE_FORM').'"  href="'.$link.'&amp;'.JSession::getFormToken().'=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('COM_VISFORMS_CHANGE_FORM_BUTTON').'</a>';
		$html[] = '  </div>';
		$html[] = '</div>';*/
