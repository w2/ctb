...
<form action="index.php?option=com_mijopolls&amp;controller=votes&amp;task=view" method="post" name="adminForm" id="adminForm">
	<table>
		<tr>
	...
	<table class="adminlist table table-striped" align="center" width="90%" cellspacing="2" cellpadding="2" border="0" >
		<thead>
			<tr>
				...
				<th width="10%"><?php echo JHTML::_('grid.sort', JText::_('COM_MIJOPOLLS_DATE'), 'v.date', @$this->lists['order_Dir'], @$this->lists['order']); ?></th>
				<th><?php echo JHTML::_('grid.sort', JText::_('COM_MIJOPOLLS_USER'), 'u.name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
