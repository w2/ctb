...
<form action="index.php" method="post" name="adminForm">
	<div class="width-40" style="float:right;">
		<fieldset class="panelform">
			...
			<?php echo JHTML::_('sliders.panel', JText::_('COM_MIJOPOLLS_PARAMS_GENERAL'), 'general-params');?>
            <fieldset class="panelform">
			...
			<?php echo JHTML::_('sliders.panel', JText::_('COM_MIJOPOLLS_RESULTS'), 'results-params');?>
            <fieldset class="panelform">
                <ul class="adminformlist">
			...
			<?php echo JHTML::_('sliders.panel', JText::_('COM_MIJOPOLLS_PARAMS_PIE'), 'pie-params');?>
            <fieldset class="panelform">
                <ul class="adminformlist">
			...
			<?php echo JHTML::_('sliders.panel', JText::_('COM_MIJOPOLLS_PARAMS_JOOMLA'), 'joomla-params');?>
            <fieldset class="panelform">
                <ul class="adminformlist">
