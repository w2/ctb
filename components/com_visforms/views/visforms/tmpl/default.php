...
<?php 
	...
	if ($required == true && $this->visforms->required == 'top')
	{
?>
...
<?php
	...
	if ($required == true && $this->visforms->required == 'captcha')
	{
?>
	<p class="vis_mandatory"><?php echo JText::_( 'COM_VISFORMS_REQUIRED' ); ?> *</p>
<?php 
	...
	if ($required == true && $this->visforms->required == 'bottom')
	{
?>
